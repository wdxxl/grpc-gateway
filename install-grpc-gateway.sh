...
curl -L https://github.com/grpc-ecosystem/grpc-gateway/archive/v1.16.0.zip -o grpc-gateway.zip
...
echo "4. downloading annotation files"
cd ~
curl -L https://github.com/protocolbuffers/protobuf/archive/v3.14.0.zip -o annonations.zip
